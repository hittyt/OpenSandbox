...
::: tip
Install the Code Interpreter SDK separately: `pip install opensandbox-code-interpreter`. The `opensandbox/code-interpreter` container image is maintained at [opensandbox-group/code-interpreter](https://github.com/opensandbox-group/code-interpreter).
:::
